...
The move beyond static presentations of analyses towards interactive applications such as this facilitates more widespread usage and analysis of said data. Specifically, the ability to link static view of the data, such as those found in VCM reports, with a URL that allows an interactive view into the data as presented in the figure is an important bridge between researchers. We hope that the adoption and continued development of biologically-informed visualization tools like this will facilitate a better understanding of pathogen evolution.
...
The data visualization presented here is amenable to showing similar multi-dimensional data, for instance linking different models to their scores across tips in the tree in much the same way we have linked reference sera to titer measurements. The JSON schema we employ here is purposefully agnostic to the pathogen or data generation approach. 
We note that similar integrated visualizations have impacted decision making beyond public health responses to human pathogens, they also have great potential to improve our understanding of related pathogens in birds \citep{Soh2019} and bats \citep{Starr2022}.
