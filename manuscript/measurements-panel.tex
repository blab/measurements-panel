...
Users can manually assign an order for specific groupings by filtering measurements to the corresponding grouping labels (Figure~\ref{fig:2}d).
...
j) Grouping label for each group of measurements. Labels appear in descending order by the number of measurements in that group (default) or in the order they have been selected by a user filter.
