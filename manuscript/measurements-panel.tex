...
This coloring is especially useful for viewing titer data by genotypes of test viruses, allowing users to inspect relationships between mutations and antigenic drift quantified by titer measurements.
...
\begin{figure}[h!]
  ...
  \caption{
    ...
    B) Neutralization results when viewed as mean $\pm$ standard deviation show a wide range of values indicating a large amount of antigenic diversity.
