...
Of the two previous visualizations we developed, the static heatmaps addressed the most user goals except for communicating the number of measurements available for each clade that support the summary statistic of mean titer distance.
