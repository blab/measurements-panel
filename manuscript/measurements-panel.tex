...
Between the interactive phylogenetic view in \emph{nextflu} and the static heatmap visualization used in WHO reports, the heatmaps addressed the most user goals.
...
We annotated mutations on the phylogenetic tree and constructed the measurements panel data JSON with Augur 18.0.0 \citep{Huddleston2021}.
